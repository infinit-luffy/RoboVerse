...
@register_task("libero.pick_ketchup", "pick_ketchup")
class LiberoPickKetchupTask(LiberoBaseTask):
    """Configuration for the Libero pick ketchup task.
    ...
    task_desc = "Pick the ketchup and place it in the basket"
    ...
    traj_filepath = "roboverse_data/trajs/libero/pick_up_the_ketchup_and_place_it_in_the_basket/v2/franka_v2.pkl.gz"
