...
class PenCfg(BaseRLTaskCfg):
    ...
    objects_cfg = {
        "pen": ArticulationObjCfg(
            name="pen",
            urdf_path="roboverse_data/assets/bidex/objects/urdf/pen_mobility/pen_mobility.urdf",
            usd_path="roboverse_data/assets/bidex/objects/usd/pen_mobility/pen_mobility.usd",
    ...
    def set_objects(self) -> None:
        """Set the objects for the shadow hand pen task."""
    ...
    def observation_fn(self, envstates: list[DictEnvState], actions: torch.Tensor, device=None) -> torch.Tensor:
        ...
        Returns:
            ...
            right pen handle position
            left pen handle position
        ...
        if self.use_prio:
            ...
            state_obs[:, t : t + 3] = pen_right_handle_pos
            t += 3
            state_obs[:, t : t + 3] = pen_left_handle_pos
            t += 3
        obs["state"] = state_obs
...
def compute_task_reward(
    ...
    Args:
        ...
        pen_right_handle_pos (tensor): The position of the right handle of the object
    ...
    success = torch.norm(pen_right_handle_pos - pen_left_handle_pos, p=2, dim=-1) > 0.275
