...
class LiberoPickMilkTask(LiberoBaseTask):
    """Configuration for the Libero pick milk task.

    This task is transferred from https://github.com/Lifelong-Robot-Learning/LIBERO/blob/master/libero/libero/bddl_files/libero_object/pick_up_the_milk_and_place_it_in_the_basket.bddl
    """
    ...
    task_desc = "Pick the milk and place it in the basket"
    ...
    traj_filepath = "roboverse_data/trajs/libero/pick_up_the_milk_and_place_it_in_the_basket/v2/franka_v2.pkl.gz"
