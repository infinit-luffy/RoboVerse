"""Configuration for the Libero living room scene3 pick up the tomato sauce and put it in the tray task."""
...
class LiberoLivingRoomScene3PickUpTomatoSauceTask(Libero90BaseTask):
    ...
    - Place the tomato_sauce inside the tray/contain_region

    This is a compound manipulation task that requires:
    1. Picking up the tomato_sauce from the table
    2. Placing the tomato_sauce inside the tray/contain_region
    ...
    Goal: Place tomato_sauce inside wooden_tray.
    """
    ...
    task_desc = "Pick up the tomato_sauce and put it in the tray (living_room_scene3)"

    workspace_name = ("living_room_table",)
    workspace_offset = ((0.0, 0, 0.42),)
    workspace_size = ((1.0, 1.2, 0.1),)

    traj_filepath = "roboverse_data/trajs/libero90/libero_90_living_room_scene3_pick_up_the_tomato_sauce_and_put_it_in_the_tray_traj_v2.pkl"

    def _terminated(self, states: TensorState) -> torch.Tensor:
        """Task success checker: tomato_sauce is inside wooden_tray/contain_region bounding box."""
