...
@configclass
class FrankaShadowHandRightCfg(BaseDexCfg):
    """Cfg for the franka with right shadow hand robot."""

    name: str = "franka_shadow_right"
    num_joints: int = 31
    ...
    usd_path: str = "roboverse_data/robots/franka_shadow_hand/usd/franka_shadow_right.usd"
