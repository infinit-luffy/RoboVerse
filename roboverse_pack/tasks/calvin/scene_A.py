...
class BaseCalvinTableTask_A(BaseCalvinTableTask):
    ...
    #             fix_base_link=False,
    #             urdf_path="roboverse_data/assets/calvin/block_pink_small.urdf",
    #         ),
    #         RigidObjCfg(
    #             name="blue_cube",
    #             scale=0.8,
    ...
    traj_filepath = (
        "roboverse_data/trajs/calvin/env_A_out/episode_chunk_132_1802438_1809815/trajectory_env_A_1237_v2.pkl"
    )
