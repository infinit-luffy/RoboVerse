...
class LiberoPickOrangeJuiceCfg(LiberoBaseTask):
    ...
    This task is transferred from https://github.com/Lifelong-Robot-Learning/LIBERO/blob/master/libero/libero/bddl_files/libero_object/pick_up_the_orange_juice_and_place_it_in_the_basket.bddl
    """
    ...
    task_desc = "Pick the orange juice and place it in the basket"
    checker = DetectedChecker(
        obj_name="orange_juice",
    ...
    traj_filepath = (
        "roboverse_data/trajs/libero/pick_up_the_orange_juice_and_place_it_in_the_basket/v2/franka_v2.pkl.gz"
    )
