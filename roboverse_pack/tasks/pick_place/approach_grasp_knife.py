...
class PickPlaceApproachGraspKnife(PickPlaceBase):
    ...
    scenario = ScenarioCfg(
        objects=[
            ...
            #     scale=(1, 1, 1),
            #     physics=PhysicStateType.RIGIDBODY,
            #     usd_path="/home/dyz/RoboVerse/roboverse_data/assets/EmbodiedGenData/example_layouts/task_0001/asset3d/knife/usd/knife.usd",
            #     urdf_path="/home/dyz/RoboVerse/roboverse_data/assets/EmbodiedGenData/example_layouts/task_0001/asset3d/knife/result/knife.urdf",
            #     mjcf_path="/home/dyz/RoboVerse/roboverse_data/assets/EmbodiedGenData/example_layouts/task_0001/asset3d/knife/mjcf/knife.xml",
            # ),
            RigidObjCfg(
                name="object0",
    ...
    def step(self, actions):
        ...
        # current_rot = current_states.objects["object"].root_state[:, 3:7].clone()
