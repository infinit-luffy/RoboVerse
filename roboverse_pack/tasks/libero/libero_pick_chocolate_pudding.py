"""Configuration for the Libero pick chocolate pudding task."""
...
@register_task("libero.pick_chocolate_pudding", "pick_chocolate_pudding")
class LiberoPickChocolatePuddingCfg(LiberoBaseTask):
    """Configuration for the Libero pick chocolate pudding task.

    This task is transferred from https://github.com/Lifelong-Robot-Learning/LIBERO/blob/master/libero/libero/bddl_files/libero_object/pick_up_the_chocolate_pudding_and_place_it_in_the_basket.bddl
    """
    ...
    task_desc = "Pick up the chocolate pudding and place it in the basket"
