"""Configuration for the Libero living room scene1 pick up the ketchup and put it in the basket task."""
...
class LiberoLivingRoomScene1PickUpKetchupAndPutItInTheBasketTask(Libero90BaseTask):
    """Configuration for the Libero living room scene1 pick up the ketchup and put it in the basket task."""
    ...
    task_desc = "Pick up the ketchup and put it in the basket (living_room_scene1)"

    workspace_name = ("living_room_table",)
    workspace_offset = ((0, 0, 0),)
    workspace_size = ((1.0, 1.2, 0.1),)

    traj_filepath = "roboverse_data/trajs/libero90/libero_90_living_room_scene1_pick_up_the_ketchup_and_put_it_in_the_basket_traj_v2.pkl"

    def _terminated(self, states: TensorState) -> torch.Tensor:
        """Task success checker: ketchup is inside basket/contain_region bounding box."""
