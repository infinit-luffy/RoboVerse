"""Configuration for the Libero pick salad dressing task."""
...
@register_task("libero.pick_salad_dressing", "pick_salad_dressing")
class LiberoPickSaladDressingTask(LiberoBaseTask):
    """Configuration for the Libero pick salad dressing task.

    This task is transferred from https://github.com/Lifelong-Robot-Learning/LIBERO/blob/master/libero/libero/bddl_files/libero_object/pick_up_the_salad_dressing_and_place_it_in_the_basket.bddl
    """
