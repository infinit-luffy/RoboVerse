...
class LiftUnderarmCfg(BaseRLTaskCfg):
    ...
    objects_cfg = {
        "pot": ArticulationObjCfg(
            name="pot",
            urdf_path="roboverse_data/assets/bidex/objects/urdf/pot_mobility/pot_mobility.urdf",
            usd_path="roboverse_data/assets/bidex/objects/usd/pot_mobility/pot_mobility.usd",
    ...
    def observation_fn(self, envstates: list[DictEnvState], actions: torch.Tensor, device=None) -> torch.Tensor:
        ...
        if self.use_prio:
            ...
            state_obs[:, t : t + 3] = pot_right_handle_pos
            t += 3
            state_obs[:, t : t + 3] = pot_left_handle_pos
            t += 3
        obs["state"] = state_obs
