...
class ScissorCfg(BaseRLTaskCfg):
    ...
    objects_cfg = {
        "scissor": ArticulationObjCfg(
            name="scissor",
            urdf_path="roboverse_data/assets/bidex/objects/urdf/scissor_mobility/scissor_mobility.urdf",
            usd_path="roboverse_data/assets/bidex/objects/usd/scissor_mobility/scissor_mobility.usd",
    ...
    def observation_fn(self, envstates: list[DictEnvState], actions: torch.Tensor, device=None) -> torch.Tensor:
        ...
        if self.use_prio:
            ...
            state_obs[:, t : t + 3] = scissor_right_handle_pos
            t += 3
            state_obs[:, t : t + 3] = scissor_left_handle_pos
            t += 3
        obs["state"] = state_obs
